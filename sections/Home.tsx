...
function Home() {
  return (
    <section id="home" className="bg-linear-40 from-white from-30% to-gray/80 px-6 pt-32 pb-12 space-y-12 md:py-32">
      <div className="max-w-360 mx-auto flex items-center md:justify-between justify-center flex-wrap-reverse gap-6 md:gap-0">
        <div className="flex flex-col md:basis-1/2 w-full gap-8 items-center md:items-start">
          ...
          <p className="text-black/80 text-xl">
            A AMANI propõe uma experiência editorial e sensível entre filosofia, educação, espiritualidade, psicanálise
            e arte.
          </p>
